...
public class ASTPrinter {
    ...
    private void printIf(JinjaIf n) {
        ...
        if (!n.elifs.isEmpty()) {
            ...
            for (JinjaIf.ElifPart e : n.elifs) {
                ind(); write("Elif { condition="+ escape(e.condition==null?"":e.condition.toString()) + " }"); nl();
            }
            indent--; ind(); write("]"); nl();
        }
    ...
    private void printFor(JinjaFor f) {
        write("JinjaFor { var=" + f.varName + " iterable=" + (f.iterable==null ? "null" : f.iterable.toString()) + " }"); nl();
    ...
    private void printBlock(JinjaBlock b) {
        write("JinjaBlock { name=" + b.name + " }"); nl();
        indent++; ind(); write("body ["); nl(); indent++;
    ...
    private void printMacro(JinjaMacro m) {
        write("JinjaMacro { name=" + m.name + " params=" + m.params.size() + " }"); nl();
        indent++; ind(); write("body ["); nl(); indent++;
